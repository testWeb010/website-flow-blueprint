  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: "You'll receive updates about Flow soon."
      });
      setEmail("");
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-4 items-start md:items-center">
            <div className="relative flex-grow">
              <input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="Email address" className="w-full px-6 py-4 rounded-full bg-black border border-dark-700 text-gray-200 focus:outline-none focus:ring-2 focus:ring-pulse-500" required />
            </div>

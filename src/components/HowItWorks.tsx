...
const HowItWorks = () => {
  ...
  const stepsData = [
    ...
    },
    {
      ...
      description: "We'll work with you to customize Flow to your specific needs and preferences.",
      image: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=800&q=80"
    },
    {
      number: "03",
      title: "Integration",
      description: "Flow installs on your system and integrates with your existing development environment.",
      image: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=800&q=80"
    },
    {
      number: "04",
      title: "Adaptation",
      description: "Through daily usage, Flow learns and adapts to your coding style, preferences, and workflow.",
      image: "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=800&q=80"
    }
  ];
    ...
    <section className="py-20 bg-white relative" id="how-it-works" ref={sectionRef}>
      ...
      <div className="section-container">
        <div className="text-center mb-16 opacity-0 fade-in-stagger">
          ...
          <h2 className="section-title mb-4">How Flow Integrates Into Your Workflow</h2>
          <p className="section-subtitle mx-auto">
            A seamless four-step process from installation to full integration.
          </p>
        </div>

  ...
  return <section id="made-by-humans" className="w-full bg-black py-0">
      <div className="section-container opacity-0 animate-on-scroll pb-2">
        ...
        <div className="w-full rounded-2xl sm:rounded-3xl overflow-hidden relative mt-6 sm:mt-8">
          ...
          backgroundImage: "linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('/background-section3.png')"
        }}>
            <div className="flex items-center text-white">
              <img src="/logo.svg" alt="Flow Logo" className="h-5 sm:h-6 w-auto mr-3 invert" />
            ...
            {/* Dark box at the bottom with overflow */}

      ...
      <section className="w-full h-screen py-10 md:py-16 sticky top-0 overflow-hidden bg-black" id="why-humanoid">
        <div className="container px-6 lg:px-8 mx-auto h-full flex flex-col">
          <div className="mb-2 md:mb-3">
            <div className="flex items-center gap-4 mb-2 md:mb-2 pt-8 sm:pt-6 md:pt-4">
              <div className="pulse-chip opacity-0 animate-fade-in" style={{
                ...
                <span>AI That Works For You, Not Against You</span>
              </div>
            </div>
          ...
          <div ref={cardsContainerRef} className="relative flex-1 perspective-1000">
            ...
            >
              <div
                className="absolute inset-0 z-0 bg-gradient-to-b from-pulse-900/40 to-black/80"
                style={{
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    Flow's AI assistants understand your code context and can help you solve complex problems, generate tests, refactor code, and explain functionality—all without your data ever leaving your control.
                  </h3>
                </div>
              </div>
            </div>
